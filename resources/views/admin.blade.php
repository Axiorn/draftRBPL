...
<div class="flex h-screen">
  ...
  <aside class="w-64 bg-white shadow-md flex flex-col">
    ...
    <nav class="flex-1 p-4">
      <ul class="space-y-4 text-gray-700">
         <li><a href="#" data-target="dashboardAdmin" class="nav-link block py-2 px-4 rounded hover:bg-green-800">Dashboard</a></li>
      <li><a href="#" data-target="penambahanProduk" class="nav-link block py-2 px-4 rounded hover:bg-green-800">Penambahan Produk</a></li>
      <li><a href="#" data-target="kelolaStok" class="nav-link block py-2 px-4 rounded hover:bg-green-800">Kelola Stok</a></li>
      <li><a href="#" data-target="riwayatPembelian" class="nav-link block py-2 px-4 rounded hover:bg-green-800">Riwayat Pembelian</a></li>
      </ul>
    </nav>
  </aside>
  ...
  <main class="flex-1 bg-[#f5f5f5] text-black p-10 overflow-y-auto">
    <section id="dashboardAdmin" class="content-section"> ... </section>
    <section id="penambahanProduk" class="content-section hidden"> ... </section>
    <section id="kelolaStok" class="content-section hidden"> ... </section>
    <section id="riwayatPembelian" class="content-section hidden"> ... </section>
    </main>
</div>
    <!-- Dashboard Admin -->
<section id="dashboardAdmin" class="p-6 space-y-6">
  ...
  <div class="bg-white rounded-xl shadow p-6 mt-4">
    ...
    <!-- Penambahan Produk -->
   <section id="penambahanProduk" class="p-6 space-y-6">
  ...
  <div class="bg-white p-6 rounded-xl shadow space-y-6">
    ...
    <!-- Kelola Stok -->
    <section id="kelolaStok" class="p-6 space-y-6">
  ...
  <div class="overflow-x-auto mt-4 bg-white rounded-xl shadow">
    ...
    <!-- Riwayat Pembelian -->
    <section id="riwayatPembelian" class="p-6 space-y-6">
